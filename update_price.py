...
def update_price_minute():
        ...
        while trial <3:
            try:
                ...
                if trial == 3:
                    error.append([i,'get_yahoo_historicals'])
    # get rid of the multiindex 
    price.to_csv("file/price_update_minute.csv")
    price = pd.read_csv("file/price_update_minute.csv")
    ...
    result.to_csv("file/Trade_suggestion_minute_1st" + str(result.TimeStamp[0])+".csv")
    ...
    result.to_csv("file/Trade_suggestion_minute_2nd" + str(result.TimeStamp[0])+".csv")
    ...
    result.to_csv("file/Trade_suggestion_minute_3rd" + str(result.TimeStamp[0])+".csv")
